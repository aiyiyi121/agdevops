...
- `backend/` is a Django project. Shared settings live in `backend/sxdevops/`; domain apps include `ops/`, `marketplace/`, `sqlaudit/`, `iac/`, `multicloud/`, `aiops/`, `rbac/`, `eventwall/`, and `cmdb/`.
